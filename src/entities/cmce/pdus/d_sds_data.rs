...
impl DSdsData {
    ...
    pub fn to_bitbuf(&self, buffer: &mut BitBuffer) -> Result<(), PduParseErr> {
        ...
        if self.short_data_type_identifier == 3 {
            ...
            // Length Indicator is 11 bits (max 2047). Never panic here: return a structured error.
            if li > 0x7FF {
                return Err(PduParseErr::ValueOutOfRange { field: "length_indicator", value: li, bits: 11, max: 0x7FF });
            }

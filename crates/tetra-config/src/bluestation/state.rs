...
pub struct StackState {
    ...
    /// Downlink frequency (Hz) the MS last camped on (radio mode). Used to bias
    /// re-acquisition on the next boot/scan. `None` until the MS camps.
    pub last_camped_freq_hz: Option<u32>,
}
